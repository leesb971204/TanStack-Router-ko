...
> 대신 [`createRootRouteWithContext`](./createRootRouteWithContextFunction.md) 함수를 사용하세요.
...
- 새로운 [`createRootRoute`](./createRootRouteFunction.md) 인스턴스를 생성하는 데 사용할 수 있는 팩토리 함수.
- 하나의 인수를 허용하며, 이는 [`createRootRoute`](./createRootRouteFunction.md) 함수와 동일합니다.
